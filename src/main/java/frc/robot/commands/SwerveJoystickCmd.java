...
public class SwerveJoystickCmd extends Command {
    ...
    private final NewSwerveSubsystem swerveSubsystem;
    private final Supplier<Double> xSpdFunction, ySpdFunction, turningSpdFunction;
    private final Supplier<Boolean> fieldOrientedFunction;
    private final SlewRateLimiter xLimiter, yLimiter, turningLimiter;

    public SwerveJoystickCmd(NewSwerveSubsystem swerveSubsystem,
    ...
    public void execute() {
        ...
        swerveSubsystem.drive(xSpdFunction.get(), ySpdFunction.get(), turningSpdFunction.get(), fieldOrientedFunction.get(), 0.02);
